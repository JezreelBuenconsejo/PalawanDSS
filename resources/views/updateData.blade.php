<div class="row register-form" style="width: 100%;">
    <div class="col" style="width: 100%;">
        ...
        <form class="custom-form">
            ...
            <div class="row form-group">
                <div class="col-7 col-sm-4 label-column" style="text-align: right;"><label class="col-form-label">Total</label></div>
            </div>
            <div class="col-md-12 text-center">
                <button class="btn btn-success submit-button" type="button">Submit&nbsp;</button>
            </div>
        </form>
    </div>
</div>
